export default {
    ...
    description: "A smart assistant system for caregivers, enabling fall detection and real-time alerts.",
    images: ["/images/[smart-assistant]main.png"],
    ...
    objective: `
      ...
      real-time assistant system designed to assist caregivers in monitoring and communicating with patients. This involved:</p>
      <ul>
        <li>Implementing visual recognition models to detect falls or lack of movement</li>
        <li>Alerting caregivers in real-time and assisting in assessing the situation through communication</li>
